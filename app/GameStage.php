...
enum GameStage: string
{
    ...
    public function guideContext(): string
    {
        return match ($this) {
            ...
            self::BEFORE_WEIRD_FRUIT => "Użytkownik na miejscu powinien się znajdować na południu Parku Lotników przy wyznaczonym drzewie.",
            self::WEIRD_FRUIT => "Drugi fragment mapy jest przyklejony do sztucznego, drewnianego jabłka zawieszonego na drzewie na wysokości ok. 3 metrów.",
            self::BEFORE_RIVER_BOTTLE => "Drugi fragment mapy zawiera zaznaczoną lokalizację 50.060239, 19.985654 - jest to zakole Wisły przy ujściu Bałuchy obok mostu Ofiar Dąbia. Użytkownik na miejscu powinien się znajdywać przy brzegu rzeki obok ujścia Bałuchy. Trzeba zjechać ze ścieżki rowerowej.",
            self::RIVER_BOTTLE => 'Trzeci fragment mapy jest w plastikowej butelce, która jest przywiązana żyłką do drzewa przy brzegu i wrzucona do rzeki.',
            self::BEFORE_LAKE => "Trzeci fragment mapy wskazuje na północną część zalewu Bagry, tuż obok cypla nazwanego 'Dzika plaża'. Dokładne współrzędne to 50.033196, 19.987455.",
            self::LAKE => "Czwarty fragment mapy znajduje się w środku pływającej bojki w wodzie zalewu w okolicach północnego cypla. Bojka unosi się na wodzie i jest przykryta mchem. W celu jej odnalezienia gracz musi wynająć rowerek wodny albo kajak i fizycznie podpłynąć w to miejsce.",
            ...
            self::AFTER_FORT => "Tutaj lokalizację podajesz ty w nagrodę za odnalezienie grzybków z poprzedniego etapu. Piąty fragment mapy znajduje się w 50.010698, 19.996919 (ukryty obok drzewa od strony wschodniej).",
            self::BEFORE_TREASURE => "Lokalizacja na mapie to 49.9996762079118, 20.009796786186364. Wskazuje na Las Krzyszkowicki.",
            self::TREASURE => "Skarb jest zakopany pod ziemią, a w ziemię and nim jest wbity sztuczny muchomor czerwony. Skarbem jest kuferek, który w środku ma prezent oraz skarb.",
